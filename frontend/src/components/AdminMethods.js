...
export const addadmin = (newUser) => {
  return axios
    .post("http://nanny-care-dashboard.herokuapp.com/AddAdmin", {
...
export const addnanny = (newNanny) => {
  return axios
    .post("http://nanny-care-dashboard.herokuapp.com/AddNanny", {
      name: newNanny.name,
...
export const adminlogin = (admin) => {
  return axios
    .post("http://nanny-care-dashboard.herokuapp.com/AdminLogin", {
